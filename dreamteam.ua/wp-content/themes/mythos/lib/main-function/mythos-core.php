...
if(!function_exists('mythos_css_generator')){
    function mythos_css_generator(){
        ...
        //logo
        $output .= '.mythos-navbar-header .mythos-navbar-brand img{width:'.esc_attr(get_theme_mod( 'logo_width')).'px; max-width:none;}';
        if (get_theme_mod( 'logo_height' )) {
            $output .= '.mythos-navbar-header .mythos-navbar-brand img{height:'.esc_attr(get_theme_mod( 'logo_height' )).'px;}';
        }
